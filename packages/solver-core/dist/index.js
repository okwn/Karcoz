 ...
 */
export async function solve(input, aiProvider) {
    ...
    const combined = calculateConfidence(question.ocrConfidence ?? 0.8, result.confidenceScore, validation.confidenceAdjustment + 0.5 // base validation score
    );
 ...
 */
function routeToSolver(question) {
 ...
 */
export function needsBetterCrop(confidence) {
