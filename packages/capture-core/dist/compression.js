 ...
 */
export async function compressCanvas(canvas, options) {
 ...
 */
export async function compressToMaxSize(canvas, maxSizeBytes, options) {
 ...
 */
export async function compressWithPreset(canvas, preset, options) {
 ...
 */
export function estimateCompressedSize(width, height, mimeType, quality) {
