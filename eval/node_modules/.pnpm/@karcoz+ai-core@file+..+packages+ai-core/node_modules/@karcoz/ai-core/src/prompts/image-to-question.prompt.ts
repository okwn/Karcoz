...
export function buildImagePrompt(options: ImagePromptOptions = {}): { system: string; user: string } {
...
export function buildSolvePrompt(question: string, explanationLevel: ExplanationLevel, language: 'en' | 'tr' = 'en'): { system: string; user: string } {
...
export function buildValidatePrompt(shortAnswer: string, question: string, language: 'en' | 'tr' = 'en'): { system: string; user: string } {
...
export function buildTopicPrompt(text: string, language: 'en' | 'tr' = 'en'): { system: string; user: string } {
